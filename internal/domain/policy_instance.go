...
func (p PolicyInstance) RequiredInputs() []PolicyInputKind {
	return clonePolicyInputKinds(p.requiredInputs)
}
func (p PolicyInstance) MissingInputBehavior() PolicyMissingInputBehavior {
	return p.missingInputBehavior
}
