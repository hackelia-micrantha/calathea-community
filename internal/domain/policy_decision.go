...
func (d PolicyDecision) RequiredInputs() []PolicyInputKind {
	return clonePolicyInputKinds(d.requiredInputs)
}
func (d PolicyDecision) InputReferences() []PolicyInputReference {
	return clonePolicyInputReferences(d.inputReferences)
}
func (d PolicyDecision) MissingInputs() []PolicyInputKind {
	return clonePolicyInputKinds(d.missingInputs)
}
